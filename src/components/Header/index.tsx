                    ...
                    <div className={styles.menu}>
                        <div className={styles.menuHeader}>
                            ...
                            <button
                                ...
                                type="button"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill="#f9f9f9" fillRule="evenodd" d="M5.47 5.47a.75.75 0 0 1 1.06 0l12 12a.75.75 0 1 1-1.06 1.06l-12-12a.75.75 0 0 1 0-1.06Z" clipRule="evenodd"/><path fill="#f9f9f9" fillRule="evenodd" d="M18.53 5.47a.75.75 0 0 1 0 1.06l-12 12a.75.75 0 0 1-1.06-1.06l12-12a.75.75 0 0 1 1.06 0Z" clipRule="evenodd"/></svg>
                            </button>
                        </div>
                        {!authToken &&
                            <button
